		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-5 left-quotation">
					...
					<ul class="l-tick">
						<li><input id="no-stone" type="checkbox"><label for="no-stone">No Stone</label></li>
					  	<li><input id="diamond" type="checkbox"><label for="diamond">Diamond</label></li>
					  	<li><input id="gemstone" type="checkbox"><label for="gemstone">Gemstone</label></li>
					</ul>
					
					<div class="label-name">SETTING</div>
					<ul class="l-tick">
						<li><input id="no-setting" type="checkbox"><label for="no-setting">No Setting</label></li>
					  	<li><input id="halo" type="checkbox"><label for="halo">Halo</label></li>
					  	<li><input id="pave" type="checkbox"><label for="pave">Pave</label></li>
						<li><input id="custom" type="checkbox"><label for="custom">Custom</label></li>
					</ul>
				    ...
				    <div class="upload-image">
				        ...
				        <input name="Select File" type="file" multiple placeholder="test" />
				    </div>
				</div>
