...
<body style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #000000;line-height: 24px;">
	<div style="width:600px;margin:0 auto;background-color:#fff;">
		...
		<div>
			<p style="margin-bottom: 10px;">We have received your message and will respond to you within 3 working days. All information received will always remain confidential. Thank you.</p>
		</div>
