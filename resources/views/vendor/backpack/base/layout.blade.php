    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="{{ url('') }}" class="logo">
          ...
          <span class="logo-mini"><b>Finard</b></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Finard</b></span>
        </a>
        <!-- Header Navbar: style can be found in header.less -->
        <nav class="navbar navbar-static-top css-header" role="navigation">
